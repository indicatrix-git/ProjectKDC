...
namespace Ditec.RIS.RFO.Controller
{
	...
	[Implements(typeof(DetailController), ServiceName = ModuleScenes.RFODetail)]
	public class RFODetailController : DetailController, IRFODetail
	{
		public RFODetailController(IShell shell)
            : base(shell)
        {
        }
